...
const caseStudies: Record<string, CaseStudy> = {
  'innovation-award': {
    ...
    subtitle: 'Recognition for Outstanding Government Technology Innovation',
    description: 'Awarded the prestigious 2023 California Government Technology Innovation Award for transforming public assistance processes and significantly improving citizen services through innovative technology solutions.',
    role: 'Product Manager & Innovation Leader',
    duration: 'Ongoing Recognition',
    team: 'Cross-functional government innovation team',
    challenge: 'Traditional government processes were slow, inefficient, and created barriers for citizens in need of emergency assistance and public services.',
    solution: 'Developed and implemented innovative technology solutions that streamlined processes, improved user experience, and created measurable improvements in government service delivery.',
    outcome: 'Successfully recognized by the State of California for outstanding innovation in government technology, validating the impact of our citizen-centered approach.',
    metrics: [
      { label: '2023', value: 'Innovation Award Winner', description: 'California Government Technology Award' },
      { label: '100%', value: 'Process Transformation', description: 'Complete modernization of legacy systems' }
    ],
    process: [
      'Identified critical pain points in government processes',
      'Designed citizen-centered technology solutions',
      'Implemented agile development methodologies',
      'Collaborated with multiple government agencies',
      'Measured and validated impact on citizen services',
      'Achieved recognition for innovation excellence'
    ],
    learnings: [
      'Government innovation requires deep understanding of regulatory constraints',
      'Citizen-centered design principles are essential for public service technology',
  ...
  'ca-governor-data-disaster': {
    ...
    subtitle: 'Leading Critical Data Infrastructure for State Emergency Response',
    description: 'Serving on the California Governor\'s Data Disaster Response Team, leading critical data infrastructure and disaster response coordination to ensure rapid deployment of emergency services and real-time data management during state-wide emergencies.',
    role: 'Senior Product Manager - Data Infrastructure',
    duration: 'Ongoing appointment',
    team: 'Multi-agency emergency response team',
    challenge: 'California faces frequent natural disasters requiring immediate, coordinated response across multiple agencies with complex data sharing needs and real-time decision making requirements.',
    solution: 'Developed comprehensive data infrastructure and coordination protocols that enable rapid emergency response, real-time data sharing, and seamless collaboration between state and local agencies during crisis situations.',
    outcome: 'Successfully maintained 24/7 emergency response capabilities with 98% system uptime, ensuring critical data availability during state emergencies and natural disasters.',
    metrics: [
      { label: '24/7', value: 'Emergency Response', description: 'Continuous operational readiness' },
      { label: '98%', value: 'System Uptime', description: 'Critical infrastructure reliability' },
      { label: '100%', value: 'Agency Coordination', description: 'Multi-agency data integration' }
    ],
    process: [
      'Emergency response protocol development',
      'Real-time data infrastructure design',
      'Multi-agency coordination frameworks',
      'Crisis communication systems implementation',
      'Continuous monitoring and optimization',
      'Post-incident analysis and improvement'
    ],
    learnings: [
      'Emergency response requires redundant systems and failover protocols',
      'Real-time data accuracy is critical during crisis situations',
      'Inter-agency coordination protocols must be tested and validated regularly',
      'Crisis communication systems need to be intuitive under high-stress conditions'
    ]
  },
  caloes: {
    id: 'caloes',
