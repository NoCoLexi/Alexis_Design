...
export default function HeroSection({ onOpenAwardModal }: HeroSectionProps) {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center relative overflow-hidden" style={{paddingTop: '100px'}}>
      ...
      <div className="flex items-start justify-start gap-12 p-8 relative w-full z-10 mt-0">
        {/* Hero Photo Section */}
        ...
        {/* Hero Text Section */}
        <div className="flex-none w-[500px] flex flex-col justify-start text-left">
