# Migrating web UI to UpStart-Labs Design System

Read `artifacts/upstart-labs-ds/docs/AGENTS.md` and
`artifacts/upstart-labs-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/upstart-labs-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/upstart-labs-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/upstart-labs-ds/hooks/use-toast`
