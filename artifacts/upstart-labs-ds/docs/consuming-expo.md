# Consuming UpStart-Labs Design System in Expo apps

Read `artifacts/upstart-labs-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/upstart-labs-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/upstart-labs-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/upstart-labs-ds/lib/native-theme";
import { useColors } from "@workspace/upstart-labs-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/upstart-labs-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/upstart-labs-ds/components/native/badge";
import { Button } from "@workspace/upstart-labs-ds/components/native/button";
import { Card } from "@workspace/upstart-labs-ds/components/native/card";
```
...
Import and render
`@workspace/upstart-labs-ds/components/native/button`, then run Expo
