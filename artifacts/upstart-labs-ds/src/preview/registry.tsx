...
export const DESIGN_SYSTEM = {
  title: 'UpStart-Labs Design System',
  description:
    'Visual language for UpStart-Labs — warm off-white surfaces, Ink type, and a signature orange accent. Newsreader for display, DM Sans for UI, DM Mono for labels.',
} as const;
