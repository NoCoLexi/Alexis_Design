...
export const DESIGN_SYSTEM = {
  title: 'Alexis Brochu Design System',
  description:
    'Personal brand for Alexis Brochu: document-grade and editorial. Cormorant Garamond for display, Inter for body and UI, Geist Mono for labels. Ember is the sole accent.',
} as const;
