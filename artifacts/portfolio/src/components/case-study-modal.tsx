...
const caseStudies: Record<string, CaseStudy> = {
  ...
  'ttools-alexis-design': {
    ...
    description: 'Comprehensive brand identity and product licensing system created by Alexis Design for TTools LLC, a stylus technology company. The project successfully resulted in the brand being sold to Fellows Office Products at Staples.',
  ...
  'abc6-rebrand-alexis-design': {
    ...
    description: 'Comprehensive company-wide brand transformation for ABC6 News by Alexis Design, collaborating directly with the brand development director to redesign all brand touchpoints from studio backdrops and mic holders to outdoor advertising campaigns and mall installations.',
