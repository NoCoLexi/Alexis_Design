        ...
        <div className="space-y-16">
          ...
          <div className="text-center max-w-[61.6rem] mx-auto">
            <p className="text-xl md:text-2xl leading-relaxed text-muted-foreground">
              ...
              The code is good. The design looks clean. But users don't understand what to do. <br />Teams can't agree on what matters. Stakeholders don't trust it. Change gets resisted. The whole system pulls in different directions.
              <br /><br />
