    ...
    <>
      ...
      <div className="disco-button flex items-center justify-center rounded-2xl">
        <button
          ...
          className="px-4 py-4 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 rounded-xl font-inter-medium text-base transition-all duration-300 text-white flex items-center gap-2 w-full justify-center relative z-10"
